...
const translations = {
  th: {
    ...
    addedToCartToast: "เพิ่ม \"{name}\" ลงตะกร้าแล้ว",
    outOfStockToast: "สินค้า \"{name}\" ในคลังหมดแล้ว!",
  ...
  en: {
    ...
    addedToCartToast: "Added \"{name}\" to cart.",
    outOfStockToast: "Product \"{name}\" is out of stock!",
